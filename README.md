...
<h3 align="center">Single Price Grid</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/DevTruce/single-price-grid" target="_blank"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://devtruce.github.io/single-price-grid/" target="_blank">View Demo</a>
    ·
    <a href="https://github.com/DevTruce/single-price-grid/issues" target="_blank">Report Bug</a>
    ·
    <a href="https://github.com/DevTruce/single-price-grid/issues" target="_blank">Request Feature</a>
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone https://github.com/DevTruce/single-price-grid.git
   ```
...
[issues-link]: https://github.com/DevTruce/single-price-grid/issues
[license-link]: https://github.com/DevTruce/single-price-grid/blob/master/LICENSE.txt
...
[issues-icon]: https://img.shields.io/github/issues/DevTruce/single-price-grid.svg?style=for-the-badge
[license-icon]: https://img.shields.io/github/license/DevTruce/single-price-grid.svg?style=for-the-badge
